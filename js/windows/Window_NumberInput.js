...
export default class Window_NumberInput extends Window_Selectable {
    ...
    start() {
        this._maxDigits = GameGlobal.$gameMessage.numInputMaxDigits();
        this._number = GameGlobal.$gameVariables.value(GameGlobal.$gameMessage.numInputVariableId());
    ...
    processOk() {
        SoundManager.playOk();
        GameGlobal.$gameVariables.setValue(GameGlobal.$gameMessage.numInputVariableId(), this._number);
